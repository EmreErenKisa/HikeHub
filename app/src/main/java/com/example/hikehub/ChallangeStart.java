...
public class ChallangeStart extends SuperScreen implements OnMapReadyCallback, TaskLoadedCallback {
    ...
    //TODO RADIO BUTTON THINGS

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_challange_start);

        routeStarted = false;
        startRoute = findViewById(R.id.createRoute);
        enterDistance = findViewById(R.id.challengeDistance);
        textView1 = findViewById(R.id.challengeText);
        leaveRoute = findViewById(R.id.leaveChallenge);
    ...
    public void finishEndScreen(View v) {
        ...
        time = end - start;
        Intent i = new Intent(this, ChallengeFinish.class);
        startActivity(i);
    }
    ...
    public void failEndScreen(View v) {
        long end = System.currentTimeMillis();
        time = end - start;
        Intent i = new Intent(this, ChallengeFail.class);
        startActivity(i);
    }
    ...
    private void createRoute() {
        new FetchURL(ChallangeStart.this).execute("https://maps.googleapis.com/maps/api/directions/json?destination=" + destination.latitude + "," + destination.longitude + "&units=metric&mode=walking&origin=" + location.latitude + "," + location.longitude + "&key=" + getString(R.string.my_API_key), "walking");
    }
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    mapFragment.getMapAsync(ChallangeStart.this);
                }
            }
        });
    }
